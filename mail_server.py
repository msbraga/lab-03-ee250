...
def save_mail(mail: List[Dict[str, str]]) -> None:
    ...
    Loads the mail (list) of dictionaries
    
    Saves the mail list as a list of strings
...
def add_mail(mail_entry: Dict[str, str]) -> str:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    Loads an email entry as a dictionary
    Generates an ID for the entry
    Adds the entry to the end of the mail
    Saves the new version of mail
...
def delete_mail(mail_id: str) -> bool:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    Loads the mail ID as a string
    Creates a counter that increases by one
    If the counter equals the ID it deletes the entry the id represents
    	It saves the new version of the mail
    	It returns the True to show id executed the operation successfully 
...
def get_mail(mail_id: str) -> Optional[Dict[str, str]]:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    Loads mail ID as a string
    Creates a loop that checks mail for entry
    If the counter equals the entry ID it returns the entry
...
def get_inbox(recipient: str) -> List[Dict[str, str]]:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    Loads a string called recipient 
    Creates a loop that checks mail for entry
    if the entry 'recipient' is in the string recipient it adds it to inbox
    Returns the string inbox
    """
    mail = load_mail()
    inbox = []
    for entry in mail:
...
def get_sent(sender: str) -> List[Dict[str, str]]:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    Loads a string called sender 
    Creates a loop that checks mail for entry
    if the entry 'sender' is in the string sender it adds it to sent
    Returns the string sent
    """
    mail = load_mail()
    sent = []
    for entry in mail:
